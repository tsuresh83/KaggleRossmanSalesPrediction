...
history <- xgb.cv(data=dtrain,params = param,nrounds=1000,nfold=5,prediction=T,feval=RMPSE,stratified = F,
                  early.stop.round = 100,maximize = F)
prefix <- paste(outputFolder,scriptName,"_",gsub(" ","",gsub(":","_",startTime)),sep="")
